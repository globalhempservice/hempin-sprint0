...
// Import the ONE shared client.
// Works whether supabaseClient exports default or { supabase }.
import supaMaybe from '../supabaseClient';
const supabase = supaMaybe?.supabase || supaMaybe;
