...
type NodeDef = {
  ...
  gem: string;          // fancy gem/metal label
...
// ring radii (in px). feel free to tweak.
const RADII = {
  1: 120,
  2: 200,
  3: 280,
    ...
    <main className="relative min-h-screen overflow-hidden bg-[#0b0b0d] text-zinc-200">
      ...
      <section className="relative z-10 mx-auto mt-12 grid place-items-center">
        <div className="relative h-[760px] w-[760px] max-w-[92vw] max-h-[92vh]">
          {/* orbits (animated rotation) */}
          <OrbitRing idx={1} radius={RADII[1]} speed="60s" />
          <OrbitRing idx={2} radius={RADII[2]} speed="90s" />
          <OrbitRing idx={3} radius={RADII[3]} speed="120s" dashed />
      ...
      {/* local styles for animation / reduced motion */}
      <style>{`
        @keyframes slowSpin {
...
function OrbitRing({
  ...
  return (
    <div
      ...
      style={{ animation: `slowSpin ${speed} linear infinite` }}
      aria-hidden
    >
      <div
...
function OrbitingPlanet({
  ...
  return (
    <button
      ...
      style={{
        // place the dot on the circumference at given angle
    ...
    >
      <div className="relative grid place-items-center">
        <div
          className={`
            h-8 w-8 md:h-10 md:w-10 rounded-full ring-1 ring-white/20
