// pages/api/admin/review/brands.ts
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  if (req.method === 'GET') {
    ...
    const base = supabaseAdmin.from('brands').select('id,name,slug,approved,featured,logo_url,category,created_at')
  ...
  if (req.method === 'PATCH') {
    const { id, approved, featured } = req.body as { id: string; approved?: boolean; featured?: boolean }
